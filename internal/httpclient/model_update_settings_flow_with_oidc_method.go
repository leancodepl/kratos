...
type UpdateSettingsFlowWithOidcMethod struct {
	...
	// IDToken is an optional id token provided by an OIDC provider  If submitted, it is verified using the OIDC provider's public key set and the claims are used to populate the OIDC credentials of the identity.  Supported providers are Apple Google type: string in: body
	IdToken *string `json:"id_token,omitempty"`
	// IDTokenNonce is the nonce, used when generating the IDToken. If the provider supports nonce validation, the nonce will be validated against this value and required.  type: string in: body
...
func (o *UpdateSettingsFlowWithOidcMethod) GetIdTokenNonce() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateSettingsFlowWithOidcMethod) GetIdTokenNonceOk() (*string, bool) {
	if o == nil || o.IdTokenNonce == nil {
		return nil, false
	}
...
func (o *UpdateSettingsFlowWithOidcMethod) HasIdTokenNonce() bool {
	if o != nil && o.IdTokenNonce != nil {
		return true
	}
...
func (o *UpdateSettingsFlowWithOidcMethod) SetIdTokenNonce(v string) {
	o.IdTokenNonce = &v
}
